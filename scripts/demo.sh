...
echo -e "${BLUE}"
echo "  ____   _    _   _  ___  ____ _____ _____ ____    ____  _____ __  __  ___  "
echo " |  _ \ / \  | \ | |/ _ \|  _ \_   _| ____/ ___|  |  _ \| ____|  \/  |/ _ \ "
echo " | |_) / _ \ |  \| | | | | |_) || | |  _| \___ \  | | | |  _| | |\/| | | | |"
echo " |  __/ ___ \| |\  | |_| |  __/ | | | |___ ___) | | |_| | |___| |  | | |_| |"
echo " |_| /_/   \_\_| \_|\___/|_|    |_| |_____|____/  |____/|_____|_|  |_|\___/ "
echo -e "${NC}"
echo ""
...
echo -e "${BLUE}============================================${NC}"
echo -e "${BLUE}          PANOPTES Demo Complete${NC}"
echo -e "${BLUE}============================================${NC}"
echo ""
...
echo ""
echo -e "${GREEN}Thank you for watching the PANOPTES demo!${NC}"
echo ""
